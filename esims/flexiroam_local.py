...
STORE = 'flexiroam_local'
FILENAME = "flexiroam_local.csv"
...
def export():
    ...
    while not pages:
        page = requests_soup("https://travel.flexiroam.com/shop/?product-tags=single-country-prepaid-mobile-data")
    ...
    for page in range(1, pages):
        ...
        while not products:
            ...
            if page == 1:
                url = "https://travel.flexiroam.com/shop/?product-tags=single-country-prepaid-mobile-data"
